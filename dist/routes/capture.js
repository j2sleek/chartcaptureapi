import { handleBatch, handleBatchStream, handleCapture, } from "../controllers/captureController.js";
...
export default async function captureRoutes(app) {
    ...
    app.post("/capture/batch/stream", {
        schema: {
            tags: ["capture"],
            summary: "Stream multiple chart captures as newline-delimited JSON",
            description: "Same body as /capture/batch, but responds with " +
